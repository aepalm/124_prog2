...
Strassen's divide and combine algorithm for matrix multiplication of $n \times n$
 matrices is asymptotically faster than the conventional
...
algorithm may be faster.  Indeed in 1990 a textbook ``Algorithms in C (1990
edition)'' suggested that $n$ would have to be in the thousands before
